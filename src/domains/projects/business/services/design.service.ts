...
import { DesignDocument } from 'src/domains/projects/data/schemas/design.schema';
import { DesignModelRepository } from 'src/domains/projects/data/repsositories/design.repository';
